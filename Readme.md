...
| [Clasificación de los MCIA](Seccion01/Clasificación)                                                             | En esta subsección se dan a conocer los diferentes tipos de motores de combustión interna alternativos, haciendo clasificaciones desde su estructura geométrica, tipo de ciclo de opración o distribución de elementos. Además, se dan a conocer cada una de las partes móviles y fijas fundamentales para el funcionamiento del motor y los accesorios o elementos complementarios a cada subsistema para su correcta operación. |             0.75             | 
