...
| Actividad                                                                                           | Alcance                                                                                                                                                                                                                                                                                                            | Dedicación,<br>4.5 horas | 
|-----------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------:|
| [Introducción a las Máquinas Térmicas](Section01/Introducción) | Explicación general del concepto de máquinas térmicas, tipos de máquinas térmicas explicando las principales diferencias en términos del proceso de combustión realizdo por el fluido de trabajo y sus principales aplicaciones. |           1            | 
| [Tipos de motores de combustión interna y componentes de un motor recíproco](Section01/Componentes)                                                             | En esta subsección se dna conocer los diferentes tipos de motores de combustión interna, haciendo énfasis en los motores de combustión interna alternativos (MCIA) hacindo clasificaciones desde su estructura geométrica, tipo de ciclo de opración o distribución de elementos. Además, se dan a conocer cada una de las partes móviles y fijas fundamentales para el funcionamiento del motor y los accesorios o elementos complementarios a cada subsistema para su correcta operación. |             1.2             | 
...
| [Caso de estudio](Section01/CasoEstudio)                                                              | En esta subsección se llevarán a cabo ejercicios que pretenden poner en práctica los conceptos dados anteriormente.       |             2.1             | 


Introducción a las máquinas térmicas. Tipos de Motores. Componentes de los motores recíprocos.
